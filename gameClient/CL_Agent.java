...
public class CL_Agent implements Comparable<CL_Agent>{
	...
	//	private long _key;
		...
		public CL_Agent(directed_weighted_graph g, int start_node) {
			...
			_id = -1;
			setSpeed(0);
			this.shortestWeight = 0;
		}

		public void setShortestWeight(double w)
		{
			this.shortestWeight = w;
		}

		public double getShortestWeight()
		{
			return this.shortestWeight;
		}
	...
	public int compare(Object o1, Object o2) {
		...
		if(o1 instanceof CL_Agent && o2 instanceof CL_Agent)
		{
			double EPS = 0.00001;
			o1 = (CL_Agent)o1;
			o2 = (CL_Agent)o2;

			double i = ((CL_Agent) o1).getShortestWeight() - ((CL_Agent) o2).getShortestWeight();
			if(i > 0 - EPS)
			{
				return 1;
			}
	...
	@Override
	public int compareTo(@NotNull CL_Agent o) {
